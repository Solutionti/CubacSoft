...
<head>
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('https://www.comunidad.madrid/sites/default/files/styles/image_style_16_9/public/img/objetos/shutterstock_552864952.jpg?itok=YI1ugXOg'); background-position: bottom;">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
              <!-- <img src="<?php echo base_url(); ?>public/img/theme/logoblanco.png" width="80px;" class="img-fluid"> -->
            <h3 class="text-white mb-2 mt-2">Bienvenido</h3>
            <h5 class="text-white mb-2 mt-2">Sistema de Votaciones en Ambiente Web</h5>
